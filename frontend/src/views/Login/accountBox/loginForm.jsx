...
export function LoginForm(props) {
  ...
  return (
    <BoxContainer>
      ...
      <MutedLink onClick={handleOpen}>Forget your password?</MutedLink>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      <Modal1 status={visible} setVisible={setVisible} title="Alert" text="Invalid Credentials, kindly enter valid credentials!" />
    </BoxContainer>
  );
}
