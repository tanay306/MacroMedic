...
const api = {
  ...
  uploadDoc: async (id, files) => {
    ...
    const data = await axios.post("http://localhost:2000/uploadDoc", postData);
    console.log(data);
    return data;
  },
  downloadDoc: async (id) => {
    ...
    console.log("IDDDD");
    console.log(id);
    const data = await axios.post("http://localhost:2000/downloadDoc", {
      id: id,
    });
    console.log(data);
    return data;
  ...
  uploadImage: async (id, img) => {
    ...
    const data = await axios.post(
      "http://localhost:2000/uploadImage",
      postData
    );
    console.log(data);
